...
function DeleteConfirmationModal({ name, isOpen, onClose, deleteCard }) {
  return (
    <div className={`popup popup_type_${name} ${isOpen ? 'popup_opened' : ''}`}>
      <div className="popup__delete-item-wrapper">
        <form className='popup__delete-item-form'>
          ...
          <button type="button" className="popup__confirm-delete-button" onClick={deleteCard}>Yes, delete item</button>
